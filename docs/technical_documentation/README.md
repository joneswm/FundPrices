...
- `tdd_workflow.md` - **MANDATORY** RED-GREEN-REFACTOR workflow
- `tdd_templates.md` - Templates and checklists for TDD cycles
- `dev_tools_config.md` - Black, isort, flake8, pre-commit and Makefile configuration
